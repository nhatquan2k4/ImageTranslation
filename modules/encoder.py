...
class Encoder(nn.Module):
    def __init__(self, image_size=224, patch_size=16, num_layers=6, num_heads=8, hidden_dim=768, mlp_dim=3072, dropout=0.1, d_model=512):
        super().__init__()
        
        # Vision Transformer để extract visual features
        self.vit = VisionTransformer(
            ...
            mlp_dim=mlp_dim,
            dropout=dropout,
            num_classes=0  # Không classification, chỉ extract features
        )
